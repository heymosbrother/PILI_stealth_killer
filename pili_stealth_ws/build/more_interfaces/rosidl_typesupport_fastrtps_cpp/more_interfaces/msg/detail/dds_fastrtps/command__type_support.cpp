...
#include "more_interfaces/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const more_interfaces::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::msg::Command & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
...
{
  auto typed_message =
    static_cast<const more_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<more_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, msg, Command)() {
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
