...
#include "command_interfaces/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = command_interfaces::srv::Command_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const command_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<command_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  return &command_interfaces::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.command_array[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = command_interfaces::srv::Command_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const command_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<command_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &command_interfaces::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &command_interfaces::srv::typesupport_fastrtps_cpp::_Command__handle;
}
