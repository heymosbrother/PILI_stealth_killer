...
CMakeFiles/server.dir/src/send_command_service.cpp.o: CMakeFiles/server.dir/flags.make
CMakeFiles/server.dir/src/send_command_service.cpp.o: /root/PILI_stealth_killer/pili_stealth_ws/src/command_interfaces/src/send_command_service.cpp
CMakeFiles/server.dir/src/send_command_service.cpp.o: CMakeFiles/server.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/PILI_stealth_killer/pili_stealth_ws/build/command_interfaces/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/server.dir/src/send_command_service.cpp.o"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT CMakeFiles/server.dir/src/send_command_service.cpp.o -MF CMakeFiles/server.dir/src/send_command_service.cpp.o.d -o CMakeFiles/server.dir/src/send_command_service.cpp.o -c /root/PILI_stealth_killer/pili_stealth_ws/src/command_interfaces/src/send_command_service.cpp

CMakeFiles/server.dir/src/send_command_service.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/server.dir/src/send_command_service.cpp.i"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/PILI_stealth_killer/pili_stealth_ws/src/command_interfaces/src/send_command_service.cpp > CMakeFiles/server.dir/src/send_command_service.cpp.i

CMakeFiles/server.dir/src/send_command_service.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/server.dir/src/send_command_service.cpp.s"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/PILI_stealth_killer/pili_stealth_ws/src/command_interfaces/src/send_command_service.cpp -o CMakeFiles/server.dir/src/send_command_service.cpp.s
...
server: CMakeFiles/server.dir/src/send_command_service.cpp.o
server: CMakeFiles/server.dir/build.make
server: /opt/ros/humble/lib/librclcpp.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_fastrtps_c.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_fastrtps_cpp.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_introspection_c.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_introspection_cpp.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_cpp.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_generator_py.so
...
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_typesupport_c.so
server: /root/PILI_stealth_killer/pili_stealth_ws/install/command_interfaces/lib/libcommand_interfaces__rosidl_generator_c.so
...
server: CMakeFiles/server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/PILI_stealth_killer/pili_stealth_ws/build/command_interfaces/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable server"
