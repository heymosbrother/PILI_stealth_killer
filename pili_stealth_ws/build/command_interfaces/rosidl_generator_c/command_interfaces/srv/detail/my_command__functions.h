...
#ifndef COMMAND_INTERFACES__SRV__DETAIL__MY_COMMAND__FUNCTIONS_H_
#define COMMAND_INTERFACES__SRV__DETAIL__MY_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/MyCommand message.
/**
...
/// Finalize srv/MyCommand message.
/**
...
/// Create srv/MyCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * command_interfaces__srv__MyCommand_Request__init().
...
/// Destroy srv/MyCommand message.
/**
 * It calls
 * command_interfaces__srv__MyCommand_Request__fini()
...
/// Check for srv/MyCommand message equality.
/**
...
/// Initialize array of srv/MyCommand messages.
/**
...
/// Finalize array of srv/MyCommand messages.
/**
 * It calls
 * command_interfaces__srv__MyCommand_Request__fini()
...
/// Create array of srv/MyCommand messages.
/**
 * It allocates the memory for the array and calls
 * command_interfaces__srv__MyCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MyCommand messages.
/**
 * It calls
 * command_interfaces__srv__MyCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MyCommand message array equality.
/**
...
/// Copy an array of srv/MyCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * command_interfaces__srv__MyCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It calls
 * command_interfaces__srv__MyCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It allocates the memory for the array and calls
 * command_interfaces__srv__MyCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It calls
 * command_interfaces__srv__MyCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMAND_INTERFACES__SRV__DETAIL__MY_COMMAND__FUNCTIONS_H_
