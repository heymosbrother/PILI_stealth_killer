...
#ifndef COMMAND_INTERFACES__SRV__DETAIL__COMMAND__FUNCTIONS_H_
#define COMMAND_INTERFACES__SRV__DETAIL__COMMAND__FUNCTIONS_H_
 ...
 * calls
 * command_interfaces__srv__Command_Request__init().
...
/**
 * It calls
 * command_interfaces__srv__Command_Request__fini()
 ...
 * command_interfaces__srv__Command_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * command_interfaces__srv__Command_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * command_interfaces__srv__Command_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It calls
 * command_interfaces__srv__Command_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It allocates the memory for the array and calls
 * command_interfaces__srv__Command_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_command_interfaces
...
/**
 * It calls
 * command_interfaces__srv__Command_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMAND_INTERFACES__SRV__DETAIL__COMMAND__FUNCTIONS_H_
