...
: ${AMENT_CURRENT_PREFIX:="/root/PILI_stealth_killer/pili_stealth_ws/install/userPkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/userPkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/userPkg/environment/path.sh"
